...
class MockHtmlDocument {
    ...
    public function getCustomTags() { return $this->customTags; }
}
...
function testRobotsGeneration() {
    ...
    if (strpos($stagingRobots, 'STAGING ENVIRONMENT') !== false && 
    ...
    if (strpos($productionRobots, 'PRODUCTION ENVIRONMENT') !== false && 
...
function testSitemapGeneration() {
    ...
    if (strpos($stagingSitemap, 'STAGING ENVIRONMENT') !== false && 
    ...
    if (strpos($productionSitemap, 'PRODUCTION ENVIRONMENT') !== false && 
