<!--
  ...
  Source : component/lib/src/Manifest/analytics.php (key=pixel_consent_mode)
...
<template>
  <div class="ab-gen-field">
    <div class="mb-3">
      <label class="ab-label" for="ab-gen-pixel-consent-mode">GDPR Consent Mode</label>
...
<script>
export default {
  name: 'GeneratedPixelConsentMode',
