...
<div class="container-fluid mt-3">
  ...
  <ul class="nav ab-view-nav mb-4">
    ...
    <li class="nav-item">
      <a class="nav-link active" href="<?php echo Route::_('index.php?option=com_aiboost&view=settings'); ?>">
  ...
  <div class="card">
    <div class="card-body">
      ...
      <!-- Vue.js Settings App mounts here -->
      <div id="ab-vue-settings"></div>

      <?php /* Add-on tab content injected by bridge plugins for addon tabs */ ?>
      <?php foreach ($this->addonTabs as $at): ?>
      <div style="display:none;" id="addon-tab-placeholder-<?php echo htmlspecialchars($at['id'], ENT_QUOTES); ?>">
        <?php echo $at['html']; ?>
      </div>
      <?php endforeach; ?>
