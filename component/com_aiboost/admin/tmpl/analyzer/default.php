...
<div class="container-fluid mt-3">
  ...
  <ul class="nav ab-view-nav mb-4">
    ...
    <li class="nav-item">
      <a class="nav-link active" href="<?php echo Route::_('index.php?option=com_aiboost&view=analyzer'); ?>">
  ...
  <script>
    window.aiBoostAnalyzer = {
      token:    '<?php echo htmlspecialchars($this->token, ENT_QUOTES, 'UTF-8'); ?>',
      tokenName:'<?php echo htmlspecialchars($tokenName, ENT_QUOTES, 'UTF-8'); ?>',
      baseUrl:  '<?php echo htmlspecialchars($this->baseUrl, ENT_QUOTES, 'UTF-8'); ?>',
      endpoints: {
        runSeo:          '<?php echo Route::_('index.php?option=com_aiboost&task=analyzer.runSeo&format=json', false); ?>',
        fetchUrl:        '<?php echo Route::_('index.php?option=com_aiboost&task=analyzer.fetchUrl&format=json', false); ?>',
        validateJsonLd:  '<?php echo Route::_('index.php?option=com_aiboost&task=analyzer.validateJsonLd&format=json', false); ?>',
