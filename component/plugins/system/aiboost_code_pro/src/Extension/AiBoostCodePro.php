<?php
/**
 * AI Boost — Code Manager Pro Plugin
 *
 * Skeleton Pro plugin for the 'code' SKU. Today this plugin only does two
 * things:
 *
 ...
 *
 * Pro logic from component/plugins/system/aiboost_code/ will be
 * relocated here as part of the physical-extraction follow-up. Until
 * that lands, the free plugin gates its Pro branches on
 * PluginRegistry::hasPro('code') (which already requires this plugin
 * + a verified license).
 *
...
namespace AiBoost\Plugin\System\AiBoostCodePro\Extension;

defined('_JEXEC') or die;

use Joomla\CMS\Plugin\CMSPlugin;

class AiBoostCodePro extends CMSPlugin
{
     ...
     * package already declares Pro fields with tier='pro' + sku='code'
