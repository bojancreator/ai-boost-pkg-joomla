...
return [
    ...
    // --- Per-feature conflict overrides (Conflict Manager) -------------------
    // Each defaults to 'inherit' → the global conflict_mode above decides.
    // 'takeover' = AI Boost always emits/applies its own output for this type;
    // 'defer'    = step aside and let the existing extension own it.
    // Consumed via AiBoost\Lib\ConflictPolicy::effectiveMode(); rendered by the
    // hand-written Conflict Manager page, not the Settings tabs.
    [
        'key'         => 'conflict_schema',
        'tab'         => 'general',
        'section'     => 'conflicts',
        ...
        'tier'        => 'free',
        'sku'         => 'core',
        'description' => 'Per-feature override for Schema.org JSON-LD when another extension or the template already emits structured data.',
        'options'     => [
            'inherit'  => 'Inherit — use the global conflict mode',
            'takeover' => 'AI Boost handles it — always emit ours',
            'defer'    => 'Defer — let the existing extension own it',
        ],
    ],
    [
        'key'         => 'conflict_og',
        'tab'         => 'general',
        'section'     => 'conflicts',
        'label'       => 'Open Graph / social meta',
        'type'        => 'select',
        'default'     => 'inherit',
        'tier'        => 'free',
        'sku'         => 'core',
        'description' => 'Per-feature override for Open Graph and Twitter Card meta tags when another extension already sets them.',
        'options'     => [
            'inherit'  => 'Inherit — use the global conflict mode',
            'takeover' => 'AI Boost handles it — always emit ours',
            'defer'    => 'Defer — let the existing extension own it',
    ...
    [
        ...
        'tier'        => 'free',
        'sku'         => 'core',
        'description' => 'Per-feature override for the XML sitemap when another sitemap extension (OSMap, Xmap, etc.) is active.',
        'options'     => [
            'inherit'  => 'Inherit — use the global conflict mode',
            'takeover' => 'AI Boost handles it — serve ours',
            'defer'    => 'Defer — let the existing sitemap extension own it',
        ],
    ],
    [
        'key'         => 'conflict_analytics',
        'tab'         => 'general',
        'section'     => 'conflicts',
        'label'       => 'Analytics (GA4 / GTM / Pixel)',
        'type'        => 'select',
        'default'     => 'inherit',
        'tier'        => 'free',
        'sku'         => 'core',
        'description' => 'Per-feature override for analytics snippets (Google Analytics 4, Google Tag Manager, Meta Pixel) when another extension already loads them.',
        'options'     => [
            'inherit'  => 'Inherit — use the global conflict mode',
            'takeover' => 'AI Boost handles it — always emit ours',
            'defer'    => 'Defer — let the existing extension own it',
    ...
    [
        ...
        'tier'        => 'free',
        'sku'         => 'core',
        'description' => 'Per-feature override for the canonical link when another SEO extension already sets one.',
        'options'     => [
            'inherit'  => 'Inherit — use the global conflict mode',
            'takeover' => 'AI Boost handles it — always set ours',
            'defer'    => 'Defer — let the existing extension own it',
        ],
    ],
    [
        ...
        'tab'         => 'general',
        'section'     => 'conflicts',
        'label'       => 'Page titles & meta description',
        'type'        => 'select',
        'default'     => 'inherit',
        'tier'        => 'free',
        'sku'         => 'core',
        'description' => 'Per-feature override for page-title and meta-description templates when another SEO extension already rewrites them.',
        'options'     => [
            'inherit'  => 'Inherit — use the global conflict mode',
            'takeover' => 'AI Boost handles it — apply our templates',
            'defer'    => 'Defer — let the existing extension own them',
        ],
    ],
    [
        'key'         => 'conflict_setup_done',
        'tab'         => 'general',
        'section'     => 'conflicts',
        'label'       => 'Conflict setup completed',
        'type'        => 'toggle',
        'default'     => '0',
        'tier'        => 'free',
        'sku'         => 'core',
        'description' => 'Internal flag set once the first-run Conflict Manager wizard has been answered. Not shown as a control.',
    ],
