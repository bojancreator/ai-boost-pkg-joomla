...
class Pagination
{
	...
	public function getPagesLinks()
	{
		 ...
		 *
		 */
		$chromePath = WblibFactory::get()
								  ->getThe('hook')
								  ->filter(
									  'forsef_pagination_chrome_path',
									  JPATH_THEMES . '/' . $this->app->getTemplate() . '/html/pagination.php'
								  );
	...
	protected function _buildDataObject()
	{
		...
		if ($this->pagesCurrent > 1)
		{
			...
			{
				// weeblr
				$data->previous->link = Route::_('index.php?' . $params . '&' . $this->prefix . 'limitstart=' . $page . $limitString);
				// weeblr
			}
		}
		...
		if ($this->pagesCurrent < $this->pagesTotal)
		{
			...
			$data->next->base = $next;
			// weeblr
			$data->next->link = Route::_('index.php?' . $params . '&' . $this->prefix . 'limitstart=' . $next . $limitString);
			//weeblr
			$data->end->base = $end;
			// weeblr
			$data->end->link = Route::_('index.php?' . $params . '&' . $this->prefix . 'limitstart=' . $end . $limitString);
			// weeblr
		}
			...
			if ($i != $this->pagesCurrent || $this->viewall)
			{
				...
				else
				{
					...
					$data->pages[$i]->link = Route::_(
						'index.php?' . $params . '&' . $this->prefix . 'limitstart=' . $offset . $limitString
					);
					// weeblr
				}
			}
