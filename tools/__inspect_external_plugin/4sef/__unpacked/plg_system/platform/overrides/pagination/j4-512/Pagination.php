...
class Pagination
{
	...
	protected function _buildDataObject()
	{
		...
		if ($this->pagesCurrent > 1)
		{
			...
			{
				// weeblr
				$data->previous->link = Route::_($params . '&' . $this->prefix . 'limitstart=' . $page . $limitString);
			}
		}
		...
		if ($this->pagesCurrent < $this->pagesTotal)
		{
			...
			$data->next->base = $next;
			// weeblr
			$data->next->link = Route::_($params . '&' . $this->prefix . 'limitstart=' . $next . $limitString);
			$data->end->base  = $end;
			// weeblr
			$data->end->link = Route::_($params . '&' . $this->prefix . 'limitstart=' . $end . $limitString);
		}
		...
		for ($i = $this->pagesStart; $i <= $stop; $i++)
		{
			...
			if ($i != $this->pagesCurrent || $this->viewall)
			{
				...
				{
					// weeblr
					$data->pages[$i]->link = Route::_($params . '&' . $this->prefix . 'limitstart=' . $offset . $limitString);
				}
			}
			else
			{
