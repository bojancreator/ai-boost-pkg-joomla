...
namespace Weeblr\Wblib\Forsef\Joomla\Utilities;

//use Joomla\String\StringHelper;
use Weeblr\Wblib\Forsef\Joomla\StringHelper;
...
final class ArrayHelper
{
	 ...
	 * @since   1.0
	 */
	public static function toString( $array, $innerGlue = '=', $outerGlue = ' ', $keepOuterKey = false)
	{
		$output = array();
	 ...
	 */
	public static function addColumn($array, $column, $colName, $keyCol = null)
	{
		$result = array();
	 ...
	 * @see     https://secure.php.net/manual/en/language.types.array.php
	 */
	public static function dropColumn( $array, $colName)
	{
		$result = array();
