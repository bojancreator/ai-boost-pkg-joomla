...
use JExtstore\Component\JMap\Administrator\Framework\Exception\Precaching as JMapExceptionPrecaching;
...
class Precacher implements IJMapXmlPrecacher {
	...
	public function __construct($fileName, FilesystemStream $fileWriter) {
		...
		$this->processStatus = $this->app->getInput()->get ( 'process_status' );
