...
/**
 * Multi-Language Text Field for JoomlaBoost
 *
 * @package     JoomlaBoost
...
/**
 * Multi-Language Text Input Field
 *
 * Renders language selector dropdown + text inputs for each installed language
 */
class MultiLangTextField extends FormField
{
    /**
     * The form field type
     *
