...
class AiBoostSchema extends CMSPlugin
{
    ...
    {
        // JSON_HEX_TAG | JSON_HEX_AMP prevent an author-controlled "</script>" in
        // any value from breaking out of this ld+json block (stored-XSS guard).
        $json = json_encode($schema, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT | JSON_HEX_TAG | JSON_HEX_AMP);
