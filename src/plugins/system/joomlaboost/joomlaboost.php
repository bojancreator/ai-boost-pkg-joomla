...
class PlgSystemJoomlaboost extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onAfterInitialise(): void
    {
        ...
        try {
            ...
            if ($app && $app->isClient('administrator')) {
                ...
                $app->enqueueMessage('JoomlaBoost v0.1.23-minimal loaded successfully (SAFE MODE)', 'info');
            }
        } catch (Exception $e) {
    ...
    public function onBeforeCompileHead(): void
    {
        ...
        try {
            ...
            $document->addCustomTag('<!-- JoomlaBoost v0.1.23-minimal SAFE MODE Active -->');
        } catch (Exception $e) {
