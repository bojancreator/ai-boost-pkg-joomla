# ⚠️ DEPRECATED — use OPERATING.md

This file is kept for historical reference only. The project has moved from Replit
to GitHub (`bojancreator/aiboost-joomla`). All operating procedures, agent rules,
build instructions, and project context now live in **`OPERATING.md`** at the repo
root.

Do not edit this file. Do not follow the procedures below — they contain stale
Replit references. Read `OPERATING.md` instead.
