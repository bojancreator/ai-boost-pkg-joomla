...
|---|---|---|---|
| staging.offroadserbia.com (live) | Pro | `0.87.45` | 2026-06-23 — Help page rebuild (problem-first + `--ab-*` retheme) + footer Support link aligned to /support, verified both themes. Committed + pushed on `design/admin-ui-refresh`. (Prior today: Schema Types `2c1ea07` + CI fix `092164b`) |
