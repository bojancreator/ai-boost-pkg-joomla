...
|---|---|---|---|
| staging.offroadserbia.com (live) | Pro | `0.87.47` | 2026-06-23 — Notifications panel (data-driven, critical pinned + counter panel) verified both themes. Pushed on `design/admin-ui-refresh`. (Prior today: Help `c914d3f`, Schema Types `2c1ea07`, CI fix `092164b`) |
