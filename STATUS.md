...
| Field | Value |
|---|---|
| **Code version** | `0.87.25` (2026-06-21) — source of truth `component/Version.php` |
...
|---|---|---|---|
| staging.offroadserbia.com (live) | Pro | `0.87.25` | 2026-06-21 — Round 3 (navbar Title Case, PRO/FREE brand tag) verified both themes. Committed: header `d5c5d4c` + round 2 `78a7cfd`; round 3 NOT yet committed |
