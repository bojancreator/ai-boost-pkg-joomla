...
|---|---|---|---|
| staging.offroadserbia.com (live) | Pro | `0.87.43` | 2026-06-23 — Schema Types info-panel fix verified both themes (8 types). Uncommitted on `design/admin-ui-refresh` |
