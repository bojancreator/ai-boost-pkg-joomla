...
|---|---|---|---|
| staging.offroadserbia.com (live) | Pro | `0.87.50` | 2026-06-23 — FAQ Manual Items JSON textarea → per-item repeater, verified both themes (existing 2 items + RU translations carried over). Prior: Notifications `9bcea1f`, Changelog `b1f7f00`, Help `c914d3f`, Schema Types `2c1ea07`, CI fix `092164b` |
